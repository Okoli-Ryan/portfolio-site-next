			...
			<motion.div
				...
				<div className="about-container">
					...
					<div className="about-right">
						...
						JavaScript, specifically ReactJs and React-Native.
						<br />
						<br /> During my free time, I love watching Basketball 🏀 and watching
						movies 🎬.
						<br />
					...
					<ul>
						<li className="work-item">
							...
							<p>
								...
								<span
									onClick={() =>
										window.open(
											"https://www.npmjs.com/package/react-native-ivorypay",
											"_blank"
										)
									}>
						...
						<li className="work-item">
							...
							<p>
								...
								the "Ajot app" (still in development), which is built with React
								Native and the dashboard built with ReactJs. I also implement
								designs from Figma files and prototypes in appropriate React JSX.
							</p>
							<p>
								I developed the{" "}
								<span
									onClick={() =>
										window.open(
											"https://play.google.com/store/apps/details?id=com.etex.nigeriteetex&hl=en&gl=US",
											"_blank"
										)
									}>
									Nigerite-Emenite app
								</span>{" "}
								for the company, and deployed to both playstore and appstore
							</p>
						</li>
					</ul>
					<h1>Education</h1>
					<ul>
						<li className="work-item">
							<h2>
								...
								<span
									onClick={() => window.open("https://oauife.edu.ng/", "_blank")}>
